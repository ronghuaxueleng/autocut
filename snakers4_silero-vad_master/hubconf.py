...
def silero_vad(onnx=False, force_onnx_cpu=False, silero_vad_source='github'):
    ...
    import os
    import sys
    hub_dir = torch.hub.get_dir() if silero_vad_source == 'github' else os.path.dirname(sys.executable)
    if onnx:
